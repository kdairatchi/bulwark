...
## Phase 1 — Stabilize the desktop agent  *(mostly landed)*
...
optional local release-signing scaffold, CI Play draft upload workflow
(`android-tv-release.yml`), VPN consent UX (education + denied retry) and
