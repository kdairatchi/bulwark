...
export const KNOWN_BLOATWARE: Omit<BloatwareApp, 'id' | 'size' | 'selected'>[] = [
  ...
  { name: 'PC Manager', packageName: 'Microsoft.MicrosoftPCManager', publisher: 'Microsoft', category: 'microsoft', description: 'PC optimization tool — redundant with Bulwrk' },
